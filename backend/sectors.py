...
SECTORS: Dict[str, SectorConfig] = {
 ...
 "tecnologia da informacao",
        ...
        keywords_a={
            ...
            "software", "softwares", "licenca de software",
            "toner", "toners", "cartucho", "cartuchos",
 ...
 "horario de expediente",
    ...
    "saude": SectorConfig(
        ...
        keywords={
            ...
            "medicamento similar", "medicamento de referencia",
            ...
            "pomada", "pomadas", "creme dermatologico",
            "solucao injetavel",
            "xarope", "xaropes", "suspensao oral",
            # Materiais de enfermagem/curativo
            "seringa", "seringas", "agulha", "agulhas",
            "luva cirurgica", "luva de procedimento",
 ...
 "prope",
    ...
    "veiculos": SectorConfig(
        ...
        keywords={
            ...
            "van", "vans", "micro-onibus",
            "utilitario",
            # Combustiveis
            "combustivel", "combustiveis",
            "gasolina", "diesel", "oleo diesel",
            "etanol", "gnv", "gas natural veicular",
            "abastecimento", "posto de combustivel",
            # Pecas e manutencao veicular
            "peca automotiva", "pecas automotivas",
            "peca de reposicao", "pecas de reposicao",
            "pneu", "pneus",
            "bateria automotiva", "baterias automotivas",
            "filtro de oleo",
            "filtro de ar", "filtro de combustivel",
            "pastilha de freio", "disco de freio",
            "amortecedor", "amortecedores",
            "lubrificante", "lubrificantes", "oleo lubrificante",
            # Servicos veiculares
            ...
            "locacao de veiculo",
            "locacao de veiculos",
            "seguro veicular", "seguro de veiculo",
 ...
 "construcao civil",
 "pavimentacao",
            "recapeamento", "recapeamento asfaltico",
 "manutencao predial",
 "impermeabilizacao",
 ...
 "servicos de borracharia",
            ...
            "infraestrutura de fibra", "infraestrutura de fibra optica",
    ...
    "hospitalar": SectorConfig(
        ...
        exclusions={
            ...
            "respirador de EPI", "respirador descartavel",
    ...
    "servicos_gerais": SectorConfig(
        ...
        keywords={
            ...
            "poda de arvore", "poda de arvores",
            "rocagem", "rocada",
            # Controle de pragas
            ...
            "brigada de incendio",
            "AVCB", "PPCI",
            "recarga de extintor", "extintor de incendio",
