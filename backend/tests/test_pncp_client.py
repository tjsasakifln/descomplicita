...
class TestPNCPClient:
    ...
    def test_session_has_correct_headers(self):
        ...
        assert client.session.headers["User-Agent"] == "Descomplicita/1.0 (procurement-search)"
...
class TestDateRangeChunking:
    ...
    # NOTE: PNCP /atas endpoint disabled — returns HTTP 500 as of 2026-03-07.
    # palavraChave parameter also not supported by PNCP consulta API (silently ignored).
    # Tests for these features removed in fix commit.
