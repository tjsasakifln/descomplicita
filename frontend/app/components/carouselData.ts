...
> = {
  legislacao: {
    ...
    header: "Você sabia?",
    icon: "scale",
    bgClass: "bg-[var(--cat-legislacao-bg)]",
    iconBgClass: "bg-[var(--cat-legislacao-icon-bg)]",
    iconTextClass: "text-[var(--cat-legislacao-text)]",
  },
  estrategia: {
    label: "Estratégia",
    header: "Estratégia",
    icon: "target",
    bgClass: "bg-[var(--cat-estrategia-bg)]",
    iconBgClass: "bg-[var(--cat-estrategia-icon-bg)]",
    iconTextClass: "text-[var(--cat-estrategia-text)]",
  },
  insight: {
    label: "Insight de Mercado",
    header: "Insight de Mercado",
    icon: "chart",
    bgClass: "bg-[var(--cat-insight-bg)]",
    iconBgClass: "bg-[var(--cat-insight-icon-bg)]",
    iconTextClass: "text-[var(--cat-insight-text)]",
  },
  dica: {
    label: "Dica Descomplicita",
    header: "Dica",
    icon: "bulb",
    bgClass: "bg-[var(--cat-dica-bg)]",
    iconBgClass: "bg-[var(--cat-dica-icon-bg)]",
    iconTextClass: "text-[var(--cat-dica-text)]",
  },
};
