...
| TD-041 | E2E tests reference outdated class names | Low | **Low** | 2-3 | Simple | No | Confirmed per DRAFT. Tests reference `bg-green-600` (old BidIQ) while UI uses `bg-brand-navy`. |
