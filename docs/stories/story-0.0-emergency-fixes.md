...
- [ ] Task 1: Update `backend/tests/test_main.py:24` -- change `assert app.title == "Descomplicita API"` to `assert app.title == "Descomplicita API"`
- [ ] Task 2: Update `backend/tests/test_main.py:238` -- fix any additional Descomplicita title assertions in the same file
- [ ] Task 3: Update `backend/tests/test_pncp_client.py:75` -- fix User-Agent assertion that checks for "Descomplicita" string
- [ ] Task 4: Search all test files for remaining "Descomplicita" references and update to "Descomplicita"
...
- [ ] All assertions in `test_main.py` reference "Descomplicita" not "Descomplicita"
- [ ] All assertions in `test_pncp_client.py` reference "Descomplicita" not "Descomplicita"
- [ ] E2E happy-path test (`01-happy-path.spec.ts`) passes end-to-end
- [ ] No test file contains the string "Descomplicita" (verified via grep)
...
- [ ] Run `grep -r "Descomplicita" backend/tests/` -- returns zero matches
...
- [ ] No "Descomplicita" references remain in any test file
